        ...
        {appState === 'landing' && (
          ...
          >
            <div className="fixed top-6 left-6 z-50 flex items-center gap-3">
              <img src="./logo.png" alt="OMG TV Logo" className="w-10 h-10 rounded-xl shadow-[0_0_15px_rgba(34,211,238,0.4)]" />
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                <img src="./logo.png" alt="OMG TV Logo" className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl shadow-[0_0_15px_rgba(34,211,238,0.4)]" />
